...
const Home = ({light, elem}) => {
    ...
    return ( 
            ...
            <main className={`${light} px-14 w-full py-24 bg-lightMode-200 dark:bg-darkMode-200`}>    
                <div className="">
                    <div className="flex flex-col lg:flex-row justify-between my-9 ">
                        <div className=" mb-5 flex items-center shadow-lg w-60">
                            <span className={`bg-lightMode-100 dark:bg-darkMode-100 w-12 lg:w-24 h-14 flex justify-center items-center rounded-l-lg gibo`}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                                </svg>                          
                            </span>
                            <input onChange={(e) => SearchCountry(e.target.value)} type="text" placeholder="search for a country..." className={`bg-lightMode-100 dark:bg-darkMode-100   w-80 lg:w-96 h-14 rounded-r-lg gibo focus:outline-none`}/>
                        </div>
                        <div>
                            <div  onClick={handleClick} className={`bg-lightMode-100 dark:bg-darkMode-100 rounded-md mb-2 w-48 h-10 flex items-center justify-between shadow-lg px-5 gibo cursor-pointer`} id="filt">
                            ...
                            <div className={`bg-lightMode-100 dark:bg-darkMode-100 rounded-md mb-10 w-48 p-2 ${top} items-center shadow-lg px-5 absolute cursor-pointer gibo`} id="filtd">
                    ...
                    <div className="country-list">
                        ...
                        {data &&  <Countries country={data} onClick={handleClick}/>}                  
                    </div>
                </div>
            </main>
     );
